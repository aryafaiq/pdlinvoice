...
<head>
  ...
  <!-- Menggunakan Lucide Icons untuk icon yang clean -->
  ...
  <style>
    ...
    body, html {
      height: 100vh;
      overflow: hidden; /* Mencegah seluruh halaman ikut ter-scroll */
    }
    .sidebar-width {
      width: 256px;
      flex-shrink: 0; /* Mencegah ukuran sidebar menyusut saat konten utama padat */
    }
  </style>
  @yield('custom-css')
</head>
<body class="bg-light d-flex m-0 h-100">
  ...
  <aside class="sidebar-width bg-white border-end border-light-subtle d-flex flex-column justify-content-between p-3 vh-100 shadow-lg">
    ...
    <div class="border-top border-light-subtle pt-3 mt-auto">
      <div class="sidebar-link d-flex align-items-center justify-content-between p-2 rounded-3" style="cursor: pointer;">
        <div class="d-flex align-items-center gap-3">
          <!-- Avatar dengan inisial -->
          <div class="bg-success-subtle text-success rounded-circle d-flex align-items-center justify-content-center fw-semibold" style="width: 36px; height: 36px; font-size: 14px;">
            PD
          </div>
