    ...
    <div class="card border-0 shadow-sm bg-white p-4 mt-4 min-vh-100">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle m-0" style="min-width: 900px;">
                <thead>
                    <tr class="">
                        <th scope="col" class="py-3 px-3 text-uppercase text-muted fw-bold"
                            style="font-size: 11px; ">No. Invoice</th>
                        <th scope="col" class="py-3 text-uppercase text-muted fw-bold"
                            style="font-size: 11px; ">Tanggal</th>
                        <th scope="col" class="py-3 text-uppercase text-muted fw-bold"
                            style="font-size: 11px; ">Penerima</th>
                        <th scope="col" class="py-3 text-uppercase text-muted fw-bold"
                            style="font-size: 11px; ">Qty</th>
                        <th scope="col" class="py-3 text-uppercase text-muted fw-bold"
                            style="font-size: 11px; ">PIC</th>
                        <th scope="col" class="py-3 text-uppercase text-muted fw-bold"
                            style="font-size: 11px; ">Status</th>
                        <th scope="col" class="py-3 text-center text-uppercase text-muted fw-bold"
